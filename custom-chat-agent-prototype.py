...
def update_template():
    ...
    # template = """You must respond to the input to the best of your ability. NEVER REPHRASE THE USER QUERY. You have access to the following tools to get relevant information/context to the question:

    # {tools}
    
    # Additionally, if you dont know what to do, respond using {main_tool}

    # Use the following format:

    # Query: the input you must respond to
    # Thought: you should always think about what to do
    # Action: the action to take, should be one of [{tool_names}] if you require additonal context, or {main_tool_name} if you are ready to respond.
    # Action Input: the input to the action
    # Observation: the result of the action
    # ... (this Thought/Action/Action Input/Observation can repeat 2 times)
    # Thought: I now know the relevant information
    # Final Answer: the final answer to the original input query, generated using {main_tool}
...
while user_input != "":
    #agent_exec.run({"input": user_input, "main_tool": main_tool})
